...
- `Multinomial-LR-TFIDF.ipynb`: Here we implemented multinomial Logistic Regression in a few different ways. We used Count Vectorizer and tf-idf Vectorizer. Furthermore we applied SVD and did some filtering and lemmatization of the statements. We also includes the addition of the new features (incl. political score) to our data. At the end of the notebook we present all the accuracies of the different multinomial models.   
